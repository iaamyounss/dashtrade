// TODO: Remove binance focuses data and make it general for CCXT
...
async function clientApiSignedBinance( apiKeys, url, endPoint, dataQueryString, method ) {
  ...
  // create a proxy to allow headers control when POST 
